...
// build mu, lambda and sigma
  ...
  lambda[i] = log1p_exp(beta_t0 + beta_t[1] * factor1[i]+ beta_t[2] * factor2[i]+ beta_t[3] * factor3[i] + beta_t[4] * factor4[i] + 
  ...
  sigma_e[i] =  log1p_exp(beta_s0 + beta_s[1] * factor1[i]+ beta_s[2] * factor2[i]+ beta_s[3] * factor3[i] + beta_s[4] * factor4[i] + 
