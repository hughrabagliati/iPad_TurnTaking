...
kid_model2 <- stan(file="fixEf_Conds_transf_expt2.stan",
                  data=stanDat_kids,
                  chains = 4, iter = 2000,  control = list(adapt_delta = 0.95))

save(eg_stan_exp2, file = "full_model_expt2.RDATA")
save(adult_model2, file = "adult_model_expt2.RDATA")
save(kid_model2, file = "child_model_expt2.RDATA")