...
Mu ~ B0 + (B1 * Pred) + (B2 * Early) + (B3 * Right/Wrong) + (B4 * Age) + ... (the full set of interactions) + (1|Subject)   
Sigma ~ B0 + (B1 * Pred) + (B2 * Early) + (B3 * Right/Wrong)+ (B4 * Age) + ... (the full set of interactions) + (1|Subject)  
Tau ~ B0 + (B1 * Pred) + (B2 * Early) + (B3 * Right/Wrong) + (B4 * Age) + ... (the full set of interactions) + (1|Subject)   
...
Mu ~ B0 + (B1 * Pred) + (B2 * Early) +  (B3 * Right/Wrong) + (B4 * Pred : Early) +  (1|Subject)  
Sigma ~ B0 + (B1 * Pred) + (B2 * Early)  + (B3 * Right/Wrong) + (B4 * Pred : Early) +  (1|Subject)   
Tau  ~ B0 + (B1 * Pred) + (B2 * Early)  + (B3 * Right/Wrong) + (B4 * Pred : Early) +  (1|Subject)   
...
Children were still modeled with an ex-Gaussian. 

## Ex-Gaussian analysis of children
<!--```{stan, output.var="exg_child"}
data {
  int<lower=1> N;
  real rt[N];
